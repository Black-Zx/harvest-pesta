    ...
    <div class="content-header row">
        <div class="content-header-left col-md-9 col-12 mb-2">
            <div class="row breadcrumbs-top">
                <div class="col-12">
                    <h2 class="content-header-title float-left mb-0">{{ __('messages.insurance_point') }}
                    </h2>
                    <div class="breadcrumb-wrapper">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="#">{{ __('messages.report') }}</a>
                            </li>
                            <li class="breadcrumb-item active">{{ __('messages.insurance_point') }}
                            </li>
                            <li class="breadcrumb-item active">{{ __('messages.insurance_report_details') }}
                            </li>
                        </ol>
                    </div>
                </div>
        ...
        <section id="team">
            ...
            <div class="row" id="table-responsive">
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">{{ __('messages.insurance_report_details') }}</h4>
                        </div>
                        <div class="card-body">
                            <h6 class="card-subtitle">{{ __('messages.date_from') }} {{$date_from}} {{__('messages.to')}} {{$date_to}} | {{__('messages.total_point_in')}} : {{$total_point_in}} | {{__('messages.total_point_out')}} : {{$total_point_out}} | {{__('messages.total_point')}} : {{$total_point_in-$total_point_out}}</h6>
                        </div>
