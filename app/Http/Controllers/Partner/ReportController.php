...
class ReportController extends BaseController {
    ...
    public function membersAndDownlinesReport(Request $request)
    {
        ...
        $descendants_user_id = User::find(auth()->user()->id)->children()->pluck('id');
        ...
        return view('partner.reports.membersAndDownlinesReport', $params);
    }
    ...
    public function memberDownlinesReport(Request $request, $id)
    {
        ...
        return view('partner.reports.memberDownlinesReport', $params);
    }
    ...
    public function insurancePointReport(Request $request)
    {
        ...
        $filtered_user_ids = User::descendantsOf(auth()->user()->id)->pluck('id');

        $user_ids = InsurancePoint::groupBy('user_id')->whereBetween('created_at', [$date_from. " 00:00:00", $date_to. " 23:59:59"])->whereIn('user_id', $filtered_user_ids)->pluck('user_id');
        ...
        return view('partner.reports.insurancePointReport', $params);
    }
    ...
    public function bonusReport(Request $request)
    {
        ...
        $user_ids = Bonus::groupBy('user_id')->whereBetween('created_at', [$date_from. " 00:00:00", $date_to. " 23:59:59"])->whereIn('user_id', $filtered_user_ids)->pluck('user_id');
        ...
        return view('partner.reports.bonusReport', $params);
    }
    ...
    public function insurancePointReportById(Request $request, $id)
    {
        ...
        return view('partner.reports.insurancePointReportById', $params);
    }
    ...
    public function bonusReportById(Request $request, $id)
    {
        ...
        return view('partner.reports.bonusReportById', $params);
    }
    ...
    public function membersWithdrawReport(Request $request)
    {
        ...
        $query = Bonus::where("transaction_type", Bonus::withdraw)->whereIn("user_id", $filtered_user_ids)->with('user', 'bank');
        ...
        return view('partner.reports.membersWithdrawReport', $params);
    }
    ...
    public function guaranteeClaimReport(Request $request)
    {
        ...
        $query = Guarantee::whereIn("user_id", $filtered_user_ids)->with('user');
        ...
        return view('partner.reports.guaranteeClaimReport', $params);
    }
    ...
    {   
        ...
        $query = UserProtectionHistory::whereIn("user_id", $filtered_user_ids)->with('user');
        ...
        return view('partner.reports.protectionReport', $params);
    }
