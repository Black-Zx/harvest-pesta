        ...
        <div class="content-body">
            <div class="auth-wrapper auth-v1 px-2">
                <div class="auth-inner py-2">
                    ...
                    <div class="card mb-0">
                        <div class="card-body">
                            <p class="text-center"><img class="img-fluid matic-logo"
                                    src="{{ asset('/app-assets/images/logo/logo.png') }}" alt="InsurBet Logo" /></p>
                            ...
                            <p class="text-center mt-2">
                                <a href="{{ route('partner.showLoginForm') }}"> <i data-feather="chevron-left"></i>
