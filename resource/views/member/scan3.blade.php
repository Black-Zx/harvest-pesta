...
<div class="qr-btn">
<h1 style="background-color:#041E41;color:#fff;">Scanner for DIY Cocktail Workshop</h1>
...
@push('scripts')
	...
	let scanner = new Instascan.Scanner({ video: document.getElementById('preview'), mirror: false, scanPeriod: 1,refractoryPeriod: 2000});
