                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <form action="{{ route('cs.approveClaim') }}" method="POST"
                                                        ...
                                                        @csrf
                                                        <label
                                                            for="final_verify_amount">{{ __('messages.final_verify_amount') }}</label>
                                                        <input type="number" id="final_verify_amount"
                                                            name="final_verify_amount" class="form-control mb-1"
                                                            style="min-width: 240px" required>
                                                        <label for="remark">{{ __('messages.remark') }}</label>
                                                        <input type="text" id="remark" name="remark"
                                                            class="form-control mb-1" maxlength="191"
                                                ...
                                                <td>
                                                    <form action="{{ route('cs.approveClaim') }}" method="POST">
                                                        @csrf
                                                        <input type="hidden" value="0" id="final_verify_amount"
                                                            name="final_verify_amount" class="form-control mb-1"
                                                            style="min-width: 240px" required>
                                                        <label for="remark">{{ __('messages.remark') }}</label>
                                                        <input type="text" id="remark" name="remark"
