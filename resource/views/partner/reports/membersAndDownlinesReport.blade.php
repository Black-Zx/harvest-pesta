        ...
        <section id="team">
            ...
            <div class="row" id="table-responsive">
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">{{ __('messages.member_downline') }}</h4>
                        </div>
                        <div class="card-body">
                                ...
                                <tbody>
                                    @if (count($report))
                                        @foreach ($report as $param)
                                            <tr>
                                                <td>
                                                    <form target="_blank" action="{{ route('partner.reports.memberDownlinesReport', ['id' => $param->id]) }}" method="GET"
                                                        class="mb-1">
                                                ...
                                                <td>{{ $param->name }}</td>
                                                <td>{{ $param->package }}</td>
                                                <td>{{ $param->protection_state == 1 ? 'Protected' : 'Unprotect' }}
                                                <td>{{ $param->rank }}</td>
