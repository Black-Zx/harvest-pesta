...
<?php $__env->startPush('scripts'); ?>
    <script>
    var scanQr = "<?php echo e(route('member.engagement')); ?>";
	...
	scanner.addListener('scan', function (unique_code) {
		...
		jQuery.ajax({
			...
			success: function(result) {
				...
				Swal.fire({
						title: 'Hi, '+result.data.name.toUpperCase()+', successful.',
						showClass: {
			...
			error: function(err) {
				Swal.fire({
					...
					// title: 'Oops, you have already made an engagement.',
					showClass: {
						popup: 'animate__animated animate__fadeInDown'
					},
					hideClass: {
...
<?php echo $__env->make('member.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/comma-zx/Documents/php/harvest-pesta/resources/views/member/engagement2.blade.php ENDPATH**/ ?>