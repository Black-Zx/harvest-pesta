                                ...
                                <table class="table table-hover mb-0">
                                    <thead>
                                        <tr>
                                            ...
                                            <th scope="col" class="text-nowrap">{{ __('messages.full_name') }}</th>
                                            <th scope="col" class="text-nowrap">{{ __('messages.tel') }}</th>
                                            <th scope="col" class="text-nowrap">{{ __('messages.purchase_amount') }}
                                            </th>
                                        ...
                                        @if (count($insurances))
                                            @foreach ($insurances as $insurance)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <form action="{{ route('cs.approveInsurancePoint') }}"
                                                            method="POST">
                                                            @csrf
