    ...
    <div class="content-header row">
        <div class="content-header-left col-md-9 col-12 mb-2">
            <div class="row breadcrumbs-top">
                <div class="col-12">
                    <h2 class="content-header-title float-left mb-0">{{ __('messages.member_withdraw_report') }}
                    </h2>
                    <div class="breadcrumb-wrapper">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="#">{{ __('messages.report') }}</a>
                            </li>
                            <li class="breadcrumb-item active">{{ __('messages.member_withdraw_report') }}
                            </li>
                        </ol>
                    </div>
                </div>
        ...
        <section id="team">
                        ...
                        <div class="card-body">
                            <form method="GET">
                                <div class="row">
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            <label for="tel">{{ __('messages.status') }}
                                            </label>
                                            <select class="form-control" id="state" name="state" required>
                                                ...
                                                <option value="-1">{{ __('messages.rejected') }}</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="row" id="table-responsive">
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">{{ __('messages.member_withdraw_report') }}</h4>
                        </div>
                        <div class="card-body">
                            <h6 class="card-subtitle">{{ __('messages.date_from') }} {{$date_from}} {{__('messages.to')}} {{$date_to}} | {{__('messages.total_withdraw_amount')}} : {{$total_withdraw}}</h6>
                        </div>
                            ...
                            <table class="table table-hover mb-0">
                                <thead>
                                    <tr>
                                        ...
                                        <th scope="col" class="text-nowrap">{{ __('messages.payment_status') }}</th>
                                        <th scope="col" class="text-nowrap">{{ __('messages.payment_date') }}</th>
                                        <th scope="col" class="text-nowrap">{{ __('messages.withdraw_amount') }}</th>
                                        <th scope="col" class="text-nowrap">{{ __('messages.bank_account_holder') }}
                                        </th>
                                        <th scope="col" class="text-nowrap">{{ __('messages.bank_account_number') }}
                                    ...
                                    @if (count($report))
                                        @foreach ($report as $param)
                                            <tr>
                                                ...
                                                <td>{{ $param->payment_date }}</td>
                                                <td>{{ $param->withdraw }}</td>
                                                <td>{{ $param->bank_account_name }}</td>
                                                <td>{{ $param->bank_account }}</td>
                                                <td>{{ $param->remark }}</td>
                                            </tr>
                                        @endforeach
                                    @else
