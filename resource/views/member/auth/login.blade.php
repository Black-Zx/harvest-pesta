                ...
                <div class="auth-inner row m-0">
                    ...
                    <div class="d-flex col-lg-4 align-items-center auth-bg px-2 p-lg-5">
                        <div class="col-12 col-sm-8 col-md-6 col-lg-12 px-xl-2 mx-auto text-center">
                            ...
                            <img class="img-fluid matic-logo" src="{{ asset('/img/carsberg-logo.png') }}" alt="Logo" />
                            ...
                            <form class="auth-login-form mt-3" method="POST">
                                ...
                                <input type="submit" class="btn btn-primary btn-block mt-2 mb-1" tabindex="4" value="{{ __('messages.sign_in') }}" />
                            </form>
                        </div>
                    </div>
                    <!-- /Login-->
