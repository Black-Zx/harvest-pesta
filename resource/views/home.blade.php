...
<div id="home" class="mt-neg40">
     <img src="{{ asset('img/bg-age-top.png') }}" class="img-fluid image-big">
     <img src="{{ asset('img/bg-age-top-mobile.png') }}" class="img-fluid image-responsive">
</div>
          ...
          <div class="container">
            <div class="row px-xl-2 mt-neg40 logo-pad"> 
                <div class="col-md-12 col-12 text-center">
                    <div class="mb-20">
                        <form action="{{route('rsvp.check', ['fd' =>$fd ])}}" method="POST" class="age-wrapper">
                            @csrf
                ...
                <div class="col-md-12 col-12 text-center pad-bot30 pad-top30 follow-small">
                    <div class="follow-width">
                        <div class="social-media mb-10">
                            <a href="https://www.facebook.com/CarlsbergMY"><img src="{{ asset('img/icon-fb.png') }}" class="img-fluid mr-10" width="20"></a>
                            <a href="https://www.instagram.com/CarlsbergMY/"><img src="{{ asset('img/icon-ig.png') }}" class="img-fluid mr-10" width="20"></a>
                        ...
                        <div class="celebrate-section">
                            <img src="{{ asset('img/twenty-one.png') }}" class="img-fluid mr-5" width="40">
                            <img src="{{ asset('img/dont-drive.png') }}" class="img-fluid mr-5" width="40">
...
<div class="home-bottom mt-neg40">
    <img src="{{ asset('img/bg-age-bottom.png') }}" class="img-fluid image-big">
     <img src="{{ asset('img/bg-age-bottom-responsive.png') }}" class="img-fluid image-responsive">
</div>  
