...
<div class="qr-btn">
<h1 style="background-color:#041E41;color:#fff;">Scanner for Redemption</h1>
...
<?php $__env->startPush('scripts'); ?>
    <script>
    var scanQr = "<?php echo e(route('member.redemption')); ?>";
	...
	scanner.addListener('scan', function (unique_code) {
		...
		jQuery.ajax({
			...
			success: function(result) {
				...
				Swal.fire({
						title: 'Hi, '+result.data.name.toUpperCase()+', successful redemption.',
						showClass: {
			...
			error: function(err) {
				Swal.fire({
					...
					// title: 'Oops, you have already made a redemption.',
					showClass: {
						popup: 'animate__animated animate__fadeInDown'
					},
					hideClass: {
...
<?php echo $__env->make('member.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/comma-zx/Documents/php/harvest-pesta/resources/views/member/redemption.blade.php ENDPATH**/ ?>