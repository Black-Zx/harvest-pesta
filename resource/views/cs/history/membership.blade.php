            ...
            <div class="row breadcrumbs-top">
                <div class="col-12">
                    ...
                    <div class="breadcrumb-wrapper">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="#">{{ __('messages.customer-service') }}</a>
                            </li>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <th scope="col" class="text-nowrap">
                                                {{ __('messages.bank_account_number') }}</th>
                                            <th scope="col" class="text-nowrap">
                                        ...
                                        @if (count($memberships))
                                            @foreach ($memberships as $membership)
                                                <tr>
                                                    ...
                                                    <td>{{ $membership->approved_at }}</td>
                                                    <td>{{ $membership->created_at }}</td>
                                                    <td>{{ $membership->username }}</td>
                                                    <td>{{ $membership->name }}</td>
                                                    <td>{{ $membership->apps_username }}</td>
                                                    <td>@foreach ($membership->packages as $package)    
                                ...
                                {{ $memberships->appends(request()->query())->links('vendor.pagination.bootstrap-4') }}
                            </div>
                        </div>
                    </div>
                </div>
